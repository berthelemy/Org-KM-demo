...
- 6.7" AMOLED display, 120 Hz adaptive refresh
- Quad-camera system: 200 MP main / 50 MP ultrawide / 10 MP telephoto (5× optical zoom) / macro
- 32 MP front camera
- 4 nm octa-core processor
- 12 GB RAM / 256 GB storage (expandable via microSD)
- 5,200 mAh battery; 65W fast charge; 30W wireless charge
- 5G, Wi-Fi 6E, Bluetooth 5.4, NFC
- IP68 dust and water resistant
- Android 15; 4 years of OS updates guaranteed
- Colour options: Midnight Black, Arctic White, Pacific Blue
...
- Early upgrade available after 12 months (residual value applied to new contract)
- Handset covered by 24-month manufacturer warranty; accidental damage cover available as add-on (£6.99/month)

## Regulatory Considerations

- Consumer credit: handset financing is a regulated credit agreement under the Consumer Credit Act 1974 — agents must not provide financial advice; present the agreement clearly and allow the customer to decide
- Cooling-off period: **14 calendar days** for remotely sold contracts
- Agents must disclose the full credit agreement cost (total amount repayable) before the customer commits
- Do not guarantee specific camera performance claims beyond what is documented in the official product specification sheet
