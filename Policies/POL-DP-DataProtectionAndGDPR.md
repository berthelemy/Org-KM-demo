...
4. **Accuracy** — data kept up to date; errors corrected promptly
5. **Storage limitation** — not kept longer than necessary
6. **Integrity and confidentiality** — secured against unauthorised access or loss
7. **Accountability** — the organisation can demonstrate compliance
...
- If a customer requests their data (Subject Access Request), refer immediately to the Data Protection Officer (DPO)
- If a customer requests erasure ("right to be forgotten"), refer immediately to DPO — do not delete records yourself
...
4. DPO assesses whether the ICO must be notified (within 72 hours of the organisation becoming aware)
